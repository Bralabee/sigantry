<!--
Sigantry-starter Azure DevOps PR template.
...
byte-identical with templates/starter/.github/pull_request_template.md
-- the export script will fail CI if they diverge.
-->
